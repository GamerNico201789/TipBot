# Tipbot is an open-source Node.js wallet bot for Discord.
...
- Written for Node.js for smoother operations. 
...
- Please check the config file for many more options available. 
